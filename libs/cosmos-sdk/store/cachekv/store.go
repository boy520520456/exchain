...
func (store *Store) setCacheValue(key, value []byte, deleted bool, dirty bool) {
	if dirty && (hex.EncodeToString(key) == "08" || hex.EncodeToString(key) == "01f1829676db577682e944fc3493d451b67ff3e29f") {
		fmt.Println("set ", dirty, hex.EncodeToString(key), hex.EncodeToString(value))
		debug.PrintStack()
	}
	keyStr := string(key)
	if !dirty {
